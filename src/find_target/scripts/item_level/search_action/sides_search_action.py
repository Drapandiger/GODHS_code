...
from item_level.view_pose_prediction.view_pose_prediction import sides_search
...
def sides_search_action(scene_name, room_name, carrier_name, target_name,
    ...
    # Step 1: 获取EE的poses
    EE_poses = sides_search(carrier_area_occupancy, obstacles_area_occupancy,
                          room_x_max, room_x_min, room_y_max, room_y_min,
    ...
    try:
        ...
        depth_sub.unregister()
        semantic_sub.unregister()
        print(f"No target '{target_name}' found on sides of {carrier_name}")
        save_knowledge_base_of_items(scene_name, room_name, carrier_name, target_name,
